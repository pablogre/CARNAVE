...
class Config:
    ...
    MYSQL_DATABASE = os.environ.get('MYSQL_DATABASE') or 'carnave'  
...
class ARCAConfig:
    ...
    CUIT = '27333429433'  # TU CUIT AQUÍ
    PUNTO_VENTA = 4       # TU PUNTO DE VENTA 3
    RAZON_SOCIAL = 'FREDIANI NOELIA' # 'PABLO GUSTAVO RE'
